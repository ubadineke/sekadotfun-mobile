...
export default function WelcomePage() {
  ...
  return (
    <LinearGradient colors={["#0F0C29", "#24243e", "#302B63"]} style={styles.container}>
      ...
      <AnimatedCircle
        animValue={circle1}
        style={[styles.circle1, { backgroundColor: "rgba(147, 51, 234, 0.15)" }]}
      />
      <AnimatedCircle
        animValue={circle2}
        style={[styles.circle2, { backgroundColor: "rgba(59, 130, 246, 0.12)" }]}
      />
      <AnimatedCircle
        animValue={circle3}
        style={[styles.circle3, { backgroundColor: "rgba(16, 185, 129, 0.18)" }]}
      />
      <AnimatedCircle
        animValue={circle4}
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        >
          <Text style={styles.footerText}>Powered by Solana • Seeker Genesis Ready</Text>
        </Animated.View>
      </SafeAreaView>
    </LinearGradient>
  );
