...
export default function HomePage() {
      ...
      >
        ...
        >
          ...
          <View style={styles.betHeader}>
            <Text style={[styles.betDescription, isClosed && styles.closedText]}>
              {bet.description}
            </Text>
          ...
          <View style={styles.actionSection}>
            <TouchableOpacity
              style={[
                styles.actionButton,
                styles.yesButton,
                isClosed && styles.disabledButton,
              ]}
              disabled={isClosed}
            >
              <LinearGradient
  ...
  return (
    <LinearGradient colors={["#0F0C29", "#24243e", "#302B63"]} style={styles.container}>
      ...
      <AnimatedCircle
        animValue={circle1}
        style={[styles.circle1, { backgroundColor: "rgba(147, 51, 234, 0.08)" }]}
      />
      <AnimatedCircle
        animValue={circle2}
        style={[styles.circle2, { backgroundColor: "rgba(59, 130, 246, 0.06)" }]}
      />
      <AnimatedCircle
        animValue={circle3}
        style={[styles.circle3, { backgroundColor: "rgba(16, 185, 129, 0.09)" }]}
      />
